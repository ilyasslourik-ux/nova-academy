...
export const UtilisateursPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingUser) {
        ...
        await userService.create({...formData, password_confirmation: formData.password});
  ...
  const openModal = (user?: User) => {
    if (user) {
      setEditingUser(user);
      setFormData({ nom: user.nom, email: user.email, password: '', role: user.role });
    } else {
      setEditingUser(null);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50/30 to-purple-50/20 p-8">
        ...
        >
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600">Gérez les admins, enseignants et étudiants</p>
            </div>
            <motion.button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredUsers.map((user, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-1">{user.nom}</h3>
              <p className="text-sm text-gray-600 mb-3">{user.email}</p>
              <span className={`inline-block px-3 py-1 rounded-lg text-xs font-semibold ${getRoleBadge(user.role)}`}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={formData.role}
                  onChange={(e) => setFormData({ ...formData, role: e.target.value as 'admin' | 'enseignant' | 'etudiant' })}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  required
                >
